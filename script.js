...
request.onload=function(){
   ...
   var totalpopu=result.reduce((initalvalue,ele)=>initalvalue+ele.population,0)
   console.log("Print the total population of countries using reduce function"+totalpopu)
